    ...
    return (
      <MobileShell>
        ...
        <div className="mx-5 mt-10 rounded-2xl bg-card p-6 text-center shadow-soft">
          ...
          <p className="mt-3 text-sm font-semibold">Sign in to view your wallet</p>
    ...
    <MobileShell>
      ...
      <section className="mx-5 mt-4 rounded-3xl bg-primary p-5 text-primary-foreground shadow-glow">
        <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider opacity-90">
          <Sparkles className="h-3.5 w-3.5" /> Pranam Credits
        </div>
      ...
      <div className="mx-5 mt-6">
        ...
        {ledgerQ.isLoading ? (
          <div className="rounded-2xl bg-card p-5 text-center text-xs text-muted-foreground shadow-soft">Loading…</div>
        ) : rows.length === 0 ? (
